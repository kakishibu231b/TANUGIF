...
namespace TANUGIF
{
    partial class MainForm
    {
        ...
        private void outputGif()
        {
            ...
            saveFileDialogGif.FileName = treeViewGif.Nodes[0].Text + ".gif";
            if (saveFileDialogGif.ShowDialog() == DialogResult.OK)
            {
                int intStepCount = 0;
        ...
        private void outputGifAsync(BackgroundWorker bw)
        {
            ...
            foreach (TreeNode projectNode in treeViewGif.Nodes)
            {
                ...
                string strOutputFilename = saveFileDialogGif.FileName;
