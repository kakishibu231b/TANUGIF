...
namespace TANUGIF
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            //メニューボタン表示状態更新
            updateMenuButtonEnabled(UpdateMenuButtonEnabledMode.UpdateMenuButtonEnabledModeNormal);
        }
        ...
        {
            UpdateMenuButtonEnabledModeBegin = 0,
            UpdateMenuButtonEnabledModeNormal,
            UpdateMenuButtonEnabledModeGifOutput,
            UpdateMenuButtonEnabledModeGifOutputEnd,
            UpdateMenuButtonEnabledModePreviewPlay,
            UpdateMenuButtonEnabledModePreviewStop,
            UpdateMenuButtonEnabledModeEnd
        }
        ...
        private void updateMenuButtonEnabled(UpdateMenuButtonEnabledMode updateMenuButtonEnabledMode)
        {
            ...
            // GIF生成
            toolStripMenuItemGifOutput.Enabled = bolExistImageNode;
            toolStripButtonGifOutput.Enabled = bolExistImageNode;

            // GIF生成中止
            toolStripMenuItemGifOutputCancel.Enabled = false;
            toolStripButtonGifOutputCancel.Enabled = false;

            // ノードを上へ移動
            toolStripMenuItemNodeUp.Enabled = bolExistProjectNode;
            toolStripButtonNodeUp.Enabled = bolExistProjectNode;

            // ノードを下へ移動
            toolStripMenuItemNodeDown.Enabled = bolExistProjectNode;
            toolStripButtonNodeDown.Enabled = bolExistProjectNode;

            // フレームノード追加
            toolStripMenuItemAddFrame.Enabled = bolExistProjectNode;
            toolStripButtonAddFrame.Enabled = bolExistProjectNode;

            // フレームノード挿入
            toolStripMenuItemInsertFrame.Enabled = bolExistProjectNode;
            toolStripButtonInsertFrame.Enabled = bolExistProjectNode;

            // ノード削除
            toolStripMenuItemDeleteNode.Enabled = bolExistProjectNode;
            toolStripButtonDeleteNode.Enabled = bolExistProjectNode;
            ...
            // GIF展開表示
            toolStripMenuItemGifExpand.Enabled = bolSelectListViewItem;
            toolStripButtonGifExpand.Enabled = bolSelectListViewItem;
            ...
            // GIF再生
            toolStripMenuItemPreviewPlay.Enabled = bolExistProjectNode;
            toolStripButtonPreviewPlay.Enabled = bolExistProjectNode;

            // GIF停止
            toolStripMenuItemPreviewStop.Enabled = false;
            toolStripButtonPreviewStop.Enabled = false;

            switch (updateMenuButtonEnabledMode)
            {
                case UpdateMenuButtonEnabledMode.UpdateMenuButtonEnabledModeGifOutput:
                    updateGifOutputMenuButtonEnabled(false);
                    break;
                case UpdateMenuButtonEnabledMode.UpdateMenuButtonEnabledModeGifOutputEnd:
                    updateGifOutputMenuButtonEnabled(true);
                    break;
                case UpdateMenuButtonEnabledMode.UpdateMenuButtonEnabledModePreviewPlay:
                    updatePreviewPlayMenuButtonEnabled(false);
                    break;
                case UpdateMenuButtonEnabledMode.UpdateMenuButtonEnabledModePreviewStop:
        ...
        private void updateGifOutputMenuButtonEnabled(bool enabled)
        {
            ...
            // GIF生成
            toolStripMenuItemGifOutput.Enabled = enabled;

            // GIF生成中止
            toolStripMenuItemGifOutputCancel.Enabled = !enabled;
            ...
            // GIF生成
            toolStripButtonGifOutput.Enabled = enabled;

            // GIF生成中止
            toolStripButtonGifOutputCancel.Enabled = !enabled;
        ...
        private void updatePreviewPlayMenuButtonEnabled(bool enabled)
        {
            ...
            // GIF再生
            toolStripMenuItemPreviewPlay.Enabled = enabled;

            // GIF停止
            toolStripMenuItemPreviewStop.Enabled = !enabled;
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void toolStripMenuItemGifOutput_Click(object sender, EventArgs e)
        {
            // 処理中
            ...
            // GIF出力メニューボタン更新
            updateMenuButtonEnabled(UpdateMenuButtonEnabledMode.UpdateMenuButtonEnabledModeGifOutput);
        }
        ...
        {
            toolStripMenuItemGifOutput.PerformClick();
        }
        ...
        private void backgroundWorkerOutput_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            // GIF出力メニューボタン更新
            updateMenuButtonEnabled(UpdateMenuButtonEnabledMode.UpdateMenuButtonEnabledModeGifOutputEnd);
        }
        ...
        {
            toolStripMenuItemGifOutputCancel.PerformClick();
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void toolStripMenuItemAddTreeNode_Click(object sender, EventArgs e)
        {
            if (listViewLib.SelectedItems.Count == 0)
            {
                return;
        ...
        {
            toolStripMenuItemAddFrame.PerformClick();
        }
        ...
        {
            toolStripMenuItemInsertFrame.PerformClick();
        }
        ...
        {
            toolStripMenuItemDeleteNode.PerformClick();
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void toolStripMenuItemGifExpand_Click(object sender, EventArgs e)
        {
            if (listViewLib.SelectedItems.Count == 0)
            {
                return;
            ...
            if (listViewLib.Visible)
            {
                ...
                toolStripMenuItemGifExpand.Checked = true;
            }
            else
            {
                listViewLibExpand.Items.Clear();
                listViewLib.Visible = true;
                toolStripMenuItemGifExpand.Checked = false;
            }
        }
        ...
        {
            toolStripMenuItemGifExpand.PerformClick();
        }
        ...
        private void toolStripMenuItemPreviewPlay_Click(object sender, EventArgs e)
        {
            ...
            // GIF再生メニューボタン更新
            updateMenuButtonEnabled(UpdateMenuButtonEnabledMode.UpdateMenuButtonEnabledModePreviewPlay);
        ...
        {
            toolStripMenuItemPreviewPlay.PerformClick();
        }
        ...
        private void toolStripMenuItemPreviewStop_Click(object sender, EventArgs e)
        {
            ...
            // GIF再生メニューボタン更新
            updateMenuButtonEnabled(UpdateMenuButtonEnabledMode.UpdateMenuButtonEnabledModePreviewStop);
        ...
        {
            toolStripMenuItemPreviewStop.PerformClick();
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void toolStripMenuItemLibFolder_Click(object sender, EventArgs e)
        {
            Settings settings = Settings.Instance;
        ...
        {
            toolStripMenuItemLibFolder.PerformClick();
        }
        ...
        private void treeView_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                toolStripButtonDeleteNode.PerformClick();
            }
            else if (e.Control && e.KeyCode == Keys.Up)
            {
                toolStripButtonNodeUp.PerformClick();
                e.Handled = true;
            }
            else if (e.Control && e.KeyCode == Keys.Down)
            {
                toolStripButtonNodeDown.PerformClick();
                e.Handled = true;
            }
        }
        ...
        private void updateDataBrowser(TreeNode selectedNode)
        {
            // 列再構築準備
