...
namespace TANUGIF
{
    internal class TreeViewControl
    {
        ...
        /// <param name="srcItem"></param>
        public static void addImageNode(TreeNode frameNode, string strImageKey, string strImageName, Image image, string strFilePath, int intFrameNumber, Point point = new Point())
        {
            // 同一画像は追加しない。
